...
export class ContactService {
    ...
    async create(
        user: User,
        request: CreateContactRequst,
    ): Promise<ContactResponse> {
        this.logger.info(`ContactService.create(${JSON.stringify(user)}, ${JSON.stringify(request)})`)
        const createRequest: CreateContactRequst = this.validationService.validate(
